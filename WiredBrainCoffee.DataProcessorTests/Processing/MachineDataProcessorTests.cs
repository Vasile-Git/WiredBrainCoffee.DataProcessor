...
public class MachineDataProcessorTests : IDisposable
{
    ...
    public void ShouldIgnoreItemsThatAreNotNewer()
    {
        ...
        {
            new MachineDataItem("Cappuccino", new DateTime(2022, 10, 27, 8, 6, 4)),
            new MachineDataItem("Cappuccino", new DateTime(2022, 10, 27, 7, 6, 4)),
            new MachineDataItem("Cappuccino", new DateTime(2022, 10, 27, 7, 10, 4)),
            new MachineDataItem("Cappuccino", new DateTime(2022, 10, 27, 9, 7, 4)),
            new MachineDataItem("Espresso", new DateTime(2022, 10, 27, 10, 8, 4)),
            new MachineDataItem("Espresso", new DateTime(2022, 10, 27, 10, 8, 4))
        };
    ...
    public void Dispose()
    {
       // This method is called after each test method / run after every test
    }
}
